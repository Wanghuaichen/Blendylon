                ...
                <!--<div class="full-width full-height">-->
                    ...
                    <!--<div id="ui-tools">-->
                        <!--<div class="full-height">-->
                            <!--<div class="ui four cards full-height" style="width: 100%;margin:0;">-->
                                <!--<div class="ui vertical icon menu inverted full-height" style="border-right: 1px solid rgba(255,255,255,0.1);margin:0;">-->
                                    <!--<a class="item active">-->
                                ...
                                <!--<timeline></timeline>-->
                                <!--&lt;!&ndash;<entities-list></entities-list>&ndash;&gt;-->
                            <!--</div>-->
                        <!--</div>-->
                    <!--</div>-->
                <!--</div>-->
...
import EntitiesList from '../app/components/panels/assets_manager/list.vue'
