<template>
    <div style="padding: 0" class="scrollable-y full-height">
        <div class="ui inverted accordion">
            ...
            <div class="title active accordion-header noselect" v-if="sceneStatistics">
                ...
                <div class="ui two column grid" >
                    <div class="column">
                        <table border="0" style="width: 100%">
                            <tr>
                                <td>Vertices</td>
                                <td style="text-align:right">{{sceneStatistics.vertices}}</td>
                            </tr>
                            <tr>
                                <td>Meshes</td>
                                <td style="text-align:right">{{sceneStatistics.meshes}}</td>
                            </tr>
                            <tr>
                                <td>Materials</td>
                                <td style="text-align:right">{{sceneStatistics.materials}}</td>
                            </tr>
                        </table>
                    </div>
                    <div class="column">
                        <table border="0" style="width: 100%">
                            <tr>
                                <td>Lights</td>
                                <td style="text-align:right">{{sceneStatistics.lights}}</td>
                            </tr>
                            <tr>
                                <td>Cameras</td>
                                <td style="text-align:right">{{sceneStatistics.cameras}}</td>
                            </tr>
                            <tr>
                                <td>Textures</td>
                                <td style="text-align:right">{{sceneStatistics.textures}}</td>
                            </tr>
                        </table>
                    </div>
                </div>
...
export default {
    ...
    computed: mapGetters({
        ...
        sceneStatistics: 'getSceneStatistics'
    })
}
</script>
